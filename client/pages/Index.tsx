...
import { Calendar, Clock, Lock, Settings } from "lucide-react"; // optional extra icon
...
export default function Index() {
  ...
  if (showBooking) {
    return <BookingFormComponent onHome={() => setShowBooking(false)} />;
  }
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="max-w-2xl mx-auto text-center mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button onClick={() => setShowBooking(true)} className="bg-primary hover:bg-primary/90 text-white px-8 py-3 text-lg">
              Book Appointment
            </Button>
            <Button
