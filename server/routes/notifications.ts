...
export async function sendBookingNotifications(
  ...
  try {
    ...
    const variables = {
      ...
      serviceName,
      providerName,
      appointmentDate: new Date(appointmentData.startTime).toLocaleDateString("en-US", { timeZone: tz }),
      appointmentTime: new Date(appointmentData.startTime).toLocaleTimeString("en-US", {
        hour: "2-digit",
        minute: "2-digit",
        timeZone: tz,
      }),
